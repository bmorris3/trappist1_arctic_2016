...
# Image paths
image_paths = sorted(glob('/Users/bmmorris/data/UT160918/Trappist_science.*.fits'))#[:-130]
...
# Photometry settings
target_centroid = np.array([[952], [906]])
comparison_flux_threshold = 0.2
aperture_radii = np.arange(30, 40, 2)
centroid_stamp_half_width = 25
psf_stddev_init = 10
aperture_annulus_radius = 10
transit_parameters = params_b


output_path = 'outputs/trappist1b_20160918.npz'
